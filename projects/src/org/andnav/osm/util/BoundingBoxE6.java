...
public class BoundingBoxE6 implements OpenStreetMapViewConstants, OpenStreetMapConstants {
	...
	public GeoPoint getGeoPointOfRelativePositionWithLinearInterpolation(final float relX, final float relY) {		
		...
		System.out.println("BoundingBoxE6.getGeo'Interpolation(): lat = " + lat + ", lon = " + lon);	
		System.out.println("BoundingBoxE6.getGeo'Interpolation(): mLatNorthE6 = " + mLatNorthE6 + ", mLonWestE6 = " + mLonWestE6);
		System.out.println("BoundingBoxE6.getGeo'Interpolation(): " +
				"getLatitudeSpanE6 = " + getLatitudeSpanE6() + ", getLongitudeSpanE6 = " + getLongitudeSpanE6());
