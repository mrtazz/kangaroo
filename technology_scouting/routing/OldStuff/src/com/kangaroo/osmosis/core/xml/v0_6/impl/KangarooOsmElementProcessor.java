 ...
 * - the formerly used NodeElementProcessor was exchanged with
 *   the KangarooNodeElementProcessor
 *   
...
import org.openstreetmap.osmosis.core.xml.v0_6.impl.*;
 ...
 */
public class KangarooOsmElementProcessor extends SourceElementProcessor {
	
	private static final Logger LOG = Logger.getLogger(KangarooOsmElementProcessor.class.getName());
	 ...
	 */
	public KangarooOsmElementProcessor(
		...
		nodeElementProcessor = new KangarooNodeElementProcessor(this, getSink(), enableDateParsing);
