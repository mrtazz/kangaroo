...
The answer is given by passing the current location, probably the last known GPS location, and the current time to the appropriate method of a \texttt{DayPlan} instance. By definition, the result is the answer to this question, a negative value indicating an incompliance between the current position and the next event. Thus I can probably not be reached in time.
